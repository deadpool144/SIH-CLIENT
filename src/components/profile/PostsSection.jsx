...
export default function PostsCard() {
  const [posts] = useState([
    {
      title: "Tips for Navigating Your First Year at Infosys",
      content:
        "Sharing my journey and key takeaways from my initial months as a Software Engineer...",
      likes: 24,
      replies: 8,
    },
    {
      ...
      content:
        "A deep dive into my competitive programming journey, challenges, and problem-solving...",
      likes: 15,
      replies: 5,
    },
  ]);
